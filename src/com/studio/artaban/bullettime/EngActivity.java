...
import com.studio.artaban.bullettime.data.EngData;
import com.studio.artaban.bullettime.social.EngFacebook;
import com.studio.artaban.bullettime.social.EngGoogle;
import com.studio.artaban.bullettime.social.EngSocial;
import com.studio.artaban.bullettime.social.EngTwitter;
...
public class EngActivity extends Activity implements SensorEventListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        try { // Initialize GStreamer
            ...
            Log.e("EngActivity", e.getMessage());
        }
